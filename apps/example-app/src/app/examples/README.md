...
- use the command `npm run test:example-app` from within the root of this repository to run the tests

The tests in this repository are written with [Vitest](https://vitest.dev/), but you can use the test runner of your choice.
