...
describe('component with child', () => {
  ...
  @Component({
    ...
    host: { 'collision-id': 'MockChildFixtureComponent' },
  })
  ...
  test('renders the component with a mocked child', async () => {
  ...
  test('renders the component with child', async () => {
    await render(ParentFixtureComponent);
    expect(screen.getByText('Parent fixture')).toBeInTheDocument();
    expect(screen.getByText('A child fixture')).toBeInTheDocument();
  });

  test('rejects render of template with componentImports set', () => {
...
describe('childComponentOverrides', () => {
  ...
  test('renders with overridden child service when specified', async () => {
    await render(ParentFixtureComponent, {
...
describe('componentOutputs', () => {
  test('should set passed event emitter to the component', async () => {
    ...
    const spy = vi.spyOn(mockEmitter, 'emit');
...
describe('on', () => {
  ...
  test('should subscribe passed listener to the component EventEmitter', async () => {
    const spy = vi.fn();
  ...
  test('should unsubscribe on rerender without listener', async () => {
    const spy = vi.fn();
  ...
  test('should not unsubscribe when same listener function is used on rerender', async () => {
    const spy = vi.fn();
    const { fixture, rerender } = await render(TestFixtureWithEventEmitterComponent, {
      on: { event: spy },
    });
  ...
  test('should unsubscribe old and subscribe new listener function on rerender', async () => {
  ...
  test('should subscribe passed listener to a derived component output', async () => {
    const spy = vi.fn();
  ...
  test('should subscribe passed listener to a functional component output', async () => {
    const spy = vi.fn();
  ...
  test('should subscribe passed listener to a functional derived component output', async () => {
    const spy = vi.fn();
  ...
  test('OutputRefKeysWithCallback is correctly typed', () => {
...
describe('Angular component life-cycle hooks', () => {
  ...
  test('invokes ngOnInit on initial render', async () => {
    const nameInitialized = vi.fn();
  ...
  test('invokes ngOnChanges with componentProperties on initial render before ngOnInit', async () => {
    const nameInitialized = vi.fn();
  ...
  test('invokes ngOnChanges with componentInputs on initial render before ngOnInit', async () => {
    const nameInitialized = vi.fn();
    const nameChanged = vi.fn();
  ...
  test('does not invoke ngOnChanges when no properties are provided', async () => {
    @Component({ template: `` })
    ...
    const spy = vi.spyOn(fixture.componentInstance, 'ngOnChanges');
...
describe('initialRoute', () => {
  ...
  test('allows initially rendering a specific route to avoid triggering a resolver for the default route', async () => {
  ...
  test('allows initially rendering a specific route with query parameters', async () => {
    @Component({
    ...
    class QueryParamFixtureComponent {
      ...
      paramPresent$ = this.route.queryParams.pipe(
        map((queryParams) => (queryParams?.['param'] ? 'present' : 'missing')),
      );
    }
...
describe('configureTestBed', () => {
  test('invokes configureTestBed', async () => {
    const configureTestBedFn = vi.fn();
    await render(FixtureComponent, {
...
describe('inputs and signals', () => {
  ...
  test('should set the input component', async () => {
  ...
  test('should typecheck correctly', async () => {
